...
// view facing right, trimmed to the shoe and set at one scale on a paper
// canvas at build time, so the crates read as one set. `verified: false` marks a name the brief says to flag, not correct.
