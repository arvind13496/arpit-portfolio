...
export default function Rule() {
  return (
    <section id="rule" aria-labelledby="rule-heading" className="bg-blue text-paper border-b-[3px] border-ink">
      <div className="mx-auto max-w-[1440px] px-4 md:px-8 py-16 md:py-32 grid grid-cols-12 gap-6">
        <p className="col-span-12"><span className="runhead">05 / The rule</span></p>
