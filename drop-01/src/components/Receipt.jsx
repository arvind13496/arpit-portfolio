...
function Line({ k, children, pending }) {
  return (
    <div className={`flex justify-between gap-x-4 gap-y-1 py-1.5 border-b-2 border-dotted border-ink ${pending ? 'flex-wrap items-baseline' : ''}`}>
    ...
    <section id="statement" aria-labelledby="statement-heading" className="border-b-4 border-ink">
      <div className="mx-auto max-w-[1440px] px-4 md:px-8 py-10 md:py-16 grid grid-cols-12 gap-6">
        <div className="col-span-12 md:col-span-5 flex flex-col gap-4">
          <p className="label">Lot 01 / Statement</p>
          <h2 id="statement-heading" className="display text-[clamp(44px,7vw,120px)]">
        ...
        <div className="col-span-12 md:col-span-6 md:col-start-7">
          <div className="max-w-md bg-paper border-4 border-ink shadow-hard-8 p-5 md:p-6">
            <div className="bg-blue text-paper -m-5 md:-m-6 mb-5 md:mb-6 p-4 border-b-4 border-ink">
              ...
              <p className="display text-3xl">A. {PERSON.last}</p>
